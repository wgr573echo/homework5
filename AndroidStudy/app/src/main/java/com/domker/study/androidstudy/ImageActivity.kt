...
//            1);
        view_pager.post {
            ...
            ReadFileTask(view_pager.width, view_pager.height).execute("/sdcard/2.jpg")
            ...
            loadNetImage1(view_pager.width, view_pager.height)
            loadNetImage2(view_pager.width, view_pager.height)
    ...
    //读取网络图片
    private fun loadNetImage1(width: Int, height: Int) {
    ...
    private fun loadNetImage2(width: Int, height: Int) {
        val imageView = layoutInflater.inflate(R.layout.activity_image_item, null) as ImageView
        pages.add(imageView)
        Thread {
            val bitmap = decodeBitmapFromNet("https://bkimg.cdn.bcebos.com/pic/71cf3bc79f3df8dcd0d602a3c411728b4710281c",
                width,
                height)
            runOnUiThread { addImageAsyn(imageView, bitmap) }
        }.start()
    ...
    private fun calculateInSampleSize(options: BitmapFactory.Options, reqWidth: Int, reqHeight: Int): Int {
        ...
        return options.outHeight/reqHeight
    }
